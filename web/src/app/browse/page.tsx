...
import { api, type AnimeMedia, type GenreData } from "@/lib/api";
  ...
  return (
    <div className="min-h-screen bg-[#0d0f14]">
      <div className="mx-auto max-w-[1440px] px-4 py-6">
        ...
        <div className="grid grid-cols-2 gap-x-2 gap-y-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7">
