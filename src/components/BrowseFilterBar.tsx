...
const selectCls =
  "browse-select h-10 w-full min-w-0 cursor-pointer appearance-none rounded-lg border border-[#2a2d3a] bg-[#1a1d28] pl-3 pr-8 text-sm text-white focus:border-[#e8621a] focus:outline-none sm:w-auto sm:min-w-[100px]";
...
export default function BrowseFilterBar({
  ...
  return (
    <div className="mb-6 grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center lg:flex-nowrap">
      {/* Search */}
      <div className="relative col-span-2 min-w-0 flex-1 sm:min-w-[180px]">
      ...
      {/* Genre */}
      <div ref={genreRef} className="relative min-w-0">
        <button
          type="button"
        ...
        {openGenre && genres && (
          <div className="absolute left-0 top-full z-50 mt-1 max-h-[60vh] w-[min(520px,calc(100vw-1.5rem))] overflow-y-auto rounded-xl border border-[#2a2d3a] bg-[#1a1d28] p-3 shadow-2xl sm:p-4">
      ...
      <select
        ...
        className={`${selectCls} sm:min-w-[130px]`}
      ...
      <button
        type="button"
        onClick={onApply}
        className="col-span-2 flex h-10 shrink-0 items-center justify-center gap-2 rounded-lg bg-[#e8621a] px-5 text-sm font-semibold text-white shadow-lg shadow-[#e8621a]/25 transition-colors hover:bg-[#d45510] sm:col-span-1"
      >
